...
namespace StoXAgent
{
    ...
    public abstract class AgentServiceBase : ServiceBase, IAgentService
    {
        ...
        /// 设置或获取是否需要停止服务处理的标志
        /// </summary>
        public virtual bool NeedStopProcess { get { return _NeedStopProcess; } set { _NeedStopProcess = value; } }
        private bool _NeedStopProcess = false;
        #endregion
                ...
                if (_Instance == null)
                {
                    ...
                    foreach (var item in AssemblyX.FindAllPlugins(typeof(AgentServiceBase), true))
                    {
                        try
                        {
                            ...
                            if ((last == null || last is AgentServiceBase) && obj != null && obj is AgentServiceBase)
                            {
